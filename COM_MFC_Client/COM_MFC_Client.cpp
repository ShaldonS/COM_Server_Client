...
// COM_MFC_Client.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCOMMFCClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCOMMFCClientApp

CCOMMFCClientApp::CCOMMFCClientApp()
{
...
// Единственный объект CCOMMFCClientApp

CCOMMFCClientApp theApp;


// Инициализация CCOMMFCClientApp

BOOL CCOMMFCClientApp::InitInstance()
{
